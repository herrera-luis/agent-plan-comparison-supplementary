...
scores are model-stable. The OpenCode row was finalized in a formal
grill-me rescoring pass (per-parameter defenses in
\texttt{scoring/grill-me-log.md}, operator-experience section); its
native headless operating mode constrains O4 to anchor-2 (revising a
