...
\texttt{[a-z]+} extension'' (Cursor's plan~Section~2: ``No structural
...
must become \texttt{([a-z0-9]+)}'' (\texttt{OPENCODE\_PLAN.md}~Section~2.3),
...
(Section~\ref{subsec:defect-convergence}): OpenSpec's 4-artefact spec format,
